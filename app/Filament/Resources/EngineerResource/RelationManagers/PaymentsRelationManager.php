...
namespace App\Filament\Resources\EngineerResource\RelationManagers;

use Akaunting\Money\Currency;
use App\Filament\Resources\Zeroloss\TaskResource;
use Filament\Forms;
        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('order.number')
                    ->url(fn ($record) => TaskResource::getUrl('edit', [$record->order]))
                    ->searchable()
                    ->sortable(),
